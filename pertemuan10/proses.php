...
if(isset($_POST['simpan'])) {
  ...
  $query = "INSERT INTO barang (kode_barang, nama_barang, kategori, lokasi, jumlah, kondisi, tanggal_masuk) VALUES ('$kode_barang', '$nama_barang', '$kategori', '$lokasi', '$jumlah', '$kondisi', '$tanggal_masuk')";
