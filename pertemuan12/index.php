  ...
  <body>
    <div class="container">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
            <h2 style="margin: 0;">SISTEM INVENTARIS BARANG</h2>
            <div style="text-align: right;">
                <span style="color: #555;">Selamat datang, <strong><?= $_SESSION['nama_lengkap']; ?></strong></span>
                <a href="logout.php" style="margin-left: 15px; background-color: #f44336; color: white; padding: 8px 15px; text-decoration: none; border-radius: 4px;">Logout</a>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <form action="proses.php" method="POST">
                ...
                <button type="submit" name="<?= $id ? 'update' : 'simpan'; ?>">
